...
//						fputc('S', pntr1);      // write an СSТ to the file, increment file pointer */ 
//						fputs(str->fname, pntr1);    // add УHello World!\r\nФ to the end of the file 
...
LedRed();
				...
				case PT_Fadd:
					{
LedRed();
//						fputs(str1->dataFlash, pntr1);    // add УHello World!\r\nФ to the end of the file 
...
//						strcpyf (a,0x31);
	...
	rx0state = RX_HDR;						// –азрешаю прием след. запроса
	}
